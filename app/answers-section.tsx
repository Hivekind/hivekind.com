            ...
            <div className="answers_component">
              <div className="margin-bottom margin-xxlarge align-left">
                <div className="max-width-large">
                  <div className="margin-bottom margin-small">
                    ...
                    >
                      We’ve got software development figured out for you
                    </h2>
                  </div>
                  <p className="text-size-medium">
                    Building a great web or mobile app isn’t easy, especially
                    when you’re a founder. You’ve got a million things on your
                    plate, and developing the app is just one of them. That’s
                    where we step in. We make the process simple and are here to
                    answer questions like these that you or your team might
                    have:
                  </p>
                </div>
              </div>
              <div className="w-layout-grid answers_list">
                ...
                <div className="answer_item">
                  ...
                  <p>
                    That’s fantastic because we charge a fixed monthly price for
                    all our services. Right from the start, we streamline
                    communication, create a clear roadmap, and align on
                    timelines and expectations to ensure your project stays on
                ...
                <div className="answer_item">
                  ...
                  <p>
                    That’s exactly where we come in. Our discovery services help
                    you turn your idea into a clear plan. We’ll work with you to
                    define the product, understand your audience, and outline
                    key features, so you’ll know exactly where to start and how
                    to move forward.
                  </p>
                </div>
                <div className="answer_item">
                  ...
                  <p>
                    AI development is progressing rapidly. We’ll help you
                    understand how AI can fit your business goals, whether it’s
                    automating tasks, enhancing user experiences, or adding
                    smart features to make your product more efficient and
                    intelligent.
                  </p>
                </div>
              </div>
